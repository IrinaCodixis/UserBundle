...
class CronTaskController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('mipa_cron_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(CronTask $entity)
    {
        $form = $this->createForm(new CronTaskType(), $entity, array(
            'action' => $this->generateUrl('mipa_cron_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new CronTaskType(), $entity, array(
            'action' => $this->generateUrl('mipa_cron_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('mipa_cron_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('mipa_cron'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('mipa_cron_delete', array('id' => $id)))
            ->setMethod('DELETE')
